...
from du_lieu_giao_duc.kho_cong_thuc import lay_danh_sach_cong_thuc, lay_chi_tiet_cong_thuc
...
from xu_ly_kiem_tra.cham_bai_anh_ai import cham_bai_tu_luan_ai
...
from xu_ly_hoc_tap.quan_ly_tien_do import lay_du_lieu_tien_do, cap_nhat_tien_do_bai_hoc
...
from xu_ly_so_tay.quan_ly_ke_hoach_hoc import doc_ke_hoach_hoc, luu_ke_hoach_hoc
from xu_ly_tro_choi.quan_ly_world_cup import khoi_tao_giai_world_cup, xu_ly_tran_dau_world_cup
from xu_ly_tro_choi.quan_ly_champions_league import khoi_tao_champions_league, xu_ly_tran_champions_league
from xu_ly_tro_choi.quan_ly_dua_xe import khoi_tao_giai_dua_xe, cap_nhat_vi_tri_dua_xe
...
def ai_engine():
    ...
    if mode == 'essay_grading':
        ...
        res_grading = cham_bai_tu_luan_ai(cau_hoi_text, bai_lam_text)
...
def games_engine():
    if request.method == 'POST':
        ...
        if game_type == 'wheel':
            ...
            match_res = xu_ly_tran_dau_world_cup(req.get('doi_a', 'Việt Nam'), req.get('doi_b', 'Nhật Bản'))
            return jsonify({"status": "success", "match": match_res})
        elif game_type == 'champions_league':
            match_res = xu_ly_tran_champions_league(req.get('doi_a', 'Real Madrid'), req.get('doi_b', 'Man City'))
            return jsonify({"status": "success", "match": match_res})

    return jsonify({
        "status": "success",
        "world_cup": khoi_tao_giai_world_cup(),
        "champions_league": khoi_tao_champions_league(),
        "racing": khoi_tao_giai_dua_xe()
    })
